        ...
        <div class="card">
            ...
            <div class="card-body collapse in">
                <div class="card-block card-dashboard">
                    ...
                    <!-- Add Staff -->
                    <a href="{{ route('addNewOfficeEmployer') }}" class="btn btn-success btn-flat" id="add-button-show"><i class="icon-plus"></i> Add Staff</a>

                    <table id="employer-list" class="table table-striped table-bordered" cellspacing="0" width="100%" data-edit="{{ route('editOfficeEmployer',null)}}">
                        <thead>
                            <tr>
                              <th>S No</th>
                              <th>Emp ID</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on("click",".employer-ad",function() {
                ...
                var actionRoute = (action == "activate") ? "{{ route('activateOfficeEmployer') }}" : "{{ route('deactivateOfficeEmployer') }}";
            ...
            $(document).on("click",".employer-delete",function() {
                ...
                function() {
                    $.ajax({
                        type: "POST",
                        async: false,
                        url: "{{ route('deleteOfficeEmployer') }}",
                        data:{
                            _token:$('input[name=_token]').val(),
                            id:id
                        },
        ...
        function initializeEmployerListDatatable(){
            var employerListTable = $('#employer-list').dataTable( { 
                ...
                "processing": false,
                "serverSide": false,
                "ajax":"{{ route('getOfficeEmployersData') }}",
