...
!function (a, b) {
  ...
  var c = [],
    ...
    return new Ta.prototype.init(a, b, c, d, e);
  }o.Tween = Ta, Ta.prototype = { constructor: Ta, init: function init(a, b, c, d, e, f) {
      ...
      var a = Ta.propHooks[this.prop];return a && a.get ? a.get(this) : Ta.propHooks._default.get(this);
    }, run: function run(a) {
      var b = Ta.propHooks[this.prop];return this.pos = this.options.duration ? o.easing[this.easing](a) : a, this.now = (this.end - this.start) * this.pos + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), b && b.set ? b.set(this) : Ta.propHooks._default.set(this), this;
    } }, Ta.prototype.init.prototype = Ta.prototype, Ta.propHooks = { _default: { get: function get(a) {
        var b;return 1 !== a.elem.nodeType || null != a.elem[a.prop] && null == a.elem.style[a.prop] ? a.elem[a.prop] : (b = o.css(a.elem, a.prop, ""), b && "auto" !== b ? b : 0);
      }, set: function set(a) {
      ...
      } } }, Ta.propHooks.scrollTop = Ta.propHooks.scrollLeft = { set: function set(a) {
      a.elem.nodeType && a.elem.parentNode && (a.elem[a.prop] = a.now);
    } }, o.easing = { linear: function linear(a) {
      return a;
    }, swing: function swing(a) {
      return .5 - Math.cos(a * Math.PI) / 2;
    }, _default: "swing" }, o.fx = Ta.prototype.init, o.fx.step = {};var Ua,
      Va,
      Wa = /^(?:toggle|show|hide)$/,
      Xa = /queueHooks$/;function Ya() {
    ...
    var d,
        ...
        p = a.style,
        q = a.nodeType && Z(a),
        r = R.get(a, "fxshow");c.queue || (g = o._queueHooks(a, "fx"), null == g.unqueued && (g.unqueued = 0, h = g.empty.fire, g.empty.fire = function () {
      g.unqueued || h();
      ...
      l && 1 === a.nodeType && (c.overflow = [p.overflow, p.overflowX, p.overflowY], j = r && r.display, null == j && (j = R.get(a, "display")), k = o.css(a, "display"), "none" === k && (j ? k = j : (ca([a], !0), j = a.style.display || j, k = o.css(a, "display"), ca([a]))), ("inline" === k || "inline-block" === k && null != j) && "none" === o.css(a, "float") && (i || (m.done(function () {
        ...
        i || (r ? "hidden" in r && (q = r.hidden) : r = R.access(a, "fxshow", { display: j }), f && (r.hidden = !q), q && ca([a], !0), m.done(function () {
          q || ca([a]), R.remove(a, "fxshow");for (d in n) {
            o.style(a, d, n[d]);
          }
    ...
    var d,
      ...
      delete i.elem;
        ...
        i = function i() {
      if (e) return !1;for (var b = Ua || Za(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0, f = 1 - d, g = 0, i = j.tweens.length; i > g; g++) {
        j.tweens[g].run(f);
      }return h.notifyWith(a, [j, f, c]), 1 > f && i ? c : (h.resolveWith(a, [j]), !1);
    },
        j = h.promise({ elem: a, props: o.extend({}, b), opts: o.extend(!0, { specialEasing: {}, easing: o.easing._default }, c), originalProperties: b, originalOptions: c, startTime: Ua || Za(), duration: c.duration, tweens: [], createTween: function createTween(b, c) {
  ...
  }o.Animation = o.extend(cb, { tweeners: { "*": [function (a, b) {
        var c = this.createTween(a, b);return _(c.elem, a, X.exec(b), c), c;
      }] }, tweener: function tweener(a, b) {
      o.isFunction(a) ? (b = a, a = ["*"]) : a = a.match(H);for (var c, d = 0, e = a.length; e > d; d++) {
        c = a[d], cb.tweeners[c] = cb.tweeners[c] || [], cb.tweeners[c].unshift(b);
      }
    }, prefilters: [ab], prefilter: function prefilter(a, b) {
    ...
    var e = a && "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) ? o.extend({}, a) : { complete: c || !c && b || o.isFunction(a) && a, duration: a, easing: c && b || b && !o.isFunction(b) && b };return o.fx.off || d.hidden ? e.duration = 0 : e.duration = "number" == typeof e.duration ? e.duration : e.duration in o.fx.speeds ? o.fx.speeds[e.duration] : o.fx.speeds._default, (null == e.queue || e.queue === !0) && (e.queue = "fx"), e.old = e.complete, e.complete = function () {
      ...
      var e = o.isEmptyObject(a),
          f = o.speed(b, c, d),
          g = function g() {
        var b = cb(this, o.extend({}, a), f);(e || R.get(this, "finish")) && b.stop(!0);
      ...
      var d = function d(a) {
        ...
        var b = !0,
            ...
            f = o.timers,
            g = R.get(this);if (e) g[e] && g[e].stop && d(g[e]);else for (e in g) {
  ...
  }), o.each({ slideDown: $a("show"), slideUp: $a("hide"), slideToggle: $a("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (a, b) {
    ...
    var a,
        b = 0,
        c = o.timers;for (Ua = o.now(); b < c.length; b++) {
    ...
    var c = eb[b] || o.find.attr;eb[b] = function (a, b, d) {
      var e, f;return d || (f = eb[b], eb[b] = e, e = null != c(a, b, d) ? b.toLowerCase() : null, eb[b] = f), e;
    };
  });var hb = /^(?:input|select|textarea|button)$/i,
      ib = /^(?:a|area)$/i;o.fn.extend({ prop: function prop(a, b) {
      ...
      var d,
          ...
          var b = o.find.attr(a, "tabindex");return b ? parseInt(b, 10) : hb.test(a.nodeName) || ib.test(a.nodeName) && a.href ? 0 : -1;
    ...
    } });var lb = /\r/g;o.fn.extend({ val: function val(a) {
      var b,
          c,
          d,
          e = this[0];{
  ...
  });var mb = /^(?:focusinfocus|focusoutblur)$/;o.extend(o.event, { trigger: function trigger(b, c, e, f) {
      var g,
          h,
          i,
          j,
    ...
    var c = function c(a) {
      ...
      ob = o.now(),
      pb = /\?/;o.parseJSON = JSON.parse, o.parseXML = function (b) {
    var c;if (!b || "string" != typeof b) return null;try {
      ...
      yb = {},
      zb = "*/".concat("*"),
      Ab = d.createElement("a");Ab.href = nb.href;function Bb(a) {
    return function (b, c) {
      "string" != typeof b && (c = b, b = "*");var d,
          e = 0,
          f = b.toLowerCase().match(H) || [];if (o.isFunction(c)) while (d = f[e++]) {
    ...
    var e,
    ...
    }, ajaxPrefilter: Bb(xb), ajaxTransport: Bb(yb), ajax: function ajax(b, c) {
      "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) && (c = b, b = void 0), c = c || {};var e,
      ...
      }if (p.data && p.processData && "string" != typeof p.data && (p.data = o.param(p.data, p.traditional)), Cb(xb, p, c, y), k) return y;l = o.event && p.global, l && 0 === o.active++ && o.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !vb.test(p.type), f = p.url.replace(rb, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(qb, "+")) : (n = p.url.slice(f.length), p.data && (f += (pb.test(f) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (f = f.replace(sb, ""), n = (pb.test(f) ? "&" : "?") + "_=" + ob++ + n), p.url = f + n), p.ifModified && (o.lastModified[f] && y.setRequestHeader("If-Modified-Since", o.lastModified[f]), o.etag[f] && y.setRequestHeader("If-None-Match", o.etag[f])), (p.data && p.hasContent && p.contentType !== !1 || c.contentType) && y.setRequestHeader("Content-Type", p.contentType), y.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + zb + "; q=0.01" : "") : p.accepts["*"]);for (m in p.headers) {
        y.setRequestHeader(m, p.headers[m]);
      }if (p.beforeSend && (p.beforeSend.call(q, y, p) === !1 || k)) return y.abort();if (x = "abort", t.add(p.complete), y.done(p.success), y.fail(p.error), e = Cb(yb, p, c, y)) {
        if (y.readyState = 1, l && r.trigger("ajaxSend", [y, p]), k) return y;p.async && p.timeout > 0 && (i = a.setTimeout(function () {
          y.abort("timeout");
        }, p.timeout));try {
          k = !1, e.send(v, A);
        } catch (z) {
        ...
        var j,
            ...
            v,
            w,
            x = c;k || (k = !0, i && a.clearTimeout(i), e = void 0, g = h || "", y.readyState = b > 0 ? 4 : 0, j = b >= 200 && 300 > b || 304 === b, d && (v = Eb(p, y, d)), v = Fb(p, v, y, j), j ? (p.ifModified && (w = y.getResponseHeader("Last-Modified"), w && (o.lastModified[f] = w), w = y.getResponseHeader("etag"), w && (o.etag[f] = w)), 204 === b || "HEAD" === p.type ? x = "nocontent" : 304 === b ? x = "notmodified" : (x = v.state, m = v.data, n = v.error, j = !n)) : (n = x, (b || !x) && (x = "error", 0 > b && (b = 0))), y.status = b, y.statusText = (c || x) + "", j ? s.resolveWith(q, [m, x, y]) : s.rejectWith(q, [y, x, n]), y.statusCode(u), u = void 0, l && r.trigger(j ? "ajaxSuccess" : "ajaxError", [y, p, j ? m : n]), t.fireWith(q, [y, x]), l && (r.trigger("ajaxComplete", [y, p]), --o.active || o.event.trigger("ajaxStop")));
      }return y;
    ...
    o[b] = function (a, c, d, e) {
      return o.isFunction(c) && (e = e || d, d = c, c = void 0), o.ajax(o.extend({ url: a, type: b, dataType: e, data: c, success: d }, o.isPlainObject(a) && a));
    };
    ...
    return !!(a.offsetWidth || a.offsetHeight || a.getClientRects().length);
      ...
      Jb = /^(?:input|select|textarea|keygen)/i;function Kb(a, b, c, d) {
    var e;if (o.isArray(b)) o.each(b, function (b, e) {
      c || Gb.test(a) ? d(a, e) : Kb(a + "[" + ("object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) && null != e ? b : "") + "]", e, c, d);
    ...
    var c,
      ...
      return this.map(function () {
        ...
        var a = this.type;return this.name && !o(this).is(":disabled") && Jb.test(this.nodeName) && !Ib.test(a) && (this.checked || !da.test(a));
      }).map(function (a, b) {
    ...
    try {
      ...
      Mb = o.ajaxSettings.xhr();l.cors = !!Mb && "withCredentials" in Mb, l.ajax = Mb = !!Mb, o.ajaxTransport(function (b) {
    var _c, d;return l.cors || Mb && !b.crossDomain ? { send: function send(e, f) {
        var g,
          ...
          return function () {
            _c && (_c = d = h.onload = h.onerror = h.onabort = h.onreadystatechange = null, "abort" === a ? h.abort() : "error" === a ? "number" != typeof h.status ? f(0, "error") : f(h.status, h.statusText) : f(Lb[h.status] || h.status, h.statusText, "text" !== (h.responseType || "text") || "string" != typeof h.responseText ? { binary: h.response } : { text: h.responseText }, h.getAllResponseHeaders()));
          };
  ...
  }), o.ajaxSetup({ accepts: { script: "text/javascript, application/javascript, application/ecmascript, application/x-ecmascript" }, contents: { script: /\b(?:java|ecma)script\b/ }, converters: { "text script": function textScript(a) {
    ...
    if (a.crossDomain) {
      var b, _c2;return { send: function send(e, f) {
          b = o("<script>").prop({ charset: a.scriptCharset, src: a.url }).on("load error", _c2 = function c(a) {
      ...
      Ob = /(=)\?(?=&|$)|\?\?/;o.ajaxSetup({ jsonp: "callback", jsonpCallback: function jsonpCallback() {
      var a = Nb.pop() || o.expando + "_" + ob++;return this[a] = !0, a;
    } }), o.ajaxPrefilter("json jsonp", function (b, c, d) {
    var e,
        f,
        g,
        h = b.jsonp !== !1 && (Ob.test(b.url) ? "url" : "string" == typeof b.data && 0 === (b.contentType || "").indexOf("application/x-www-form-urlencoded") && Ob.test(b.data) && "data");return h || "jsonp" === b.dataTypes[0] ? (e = b.jsonpCallback = o.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, h ? b[h] = b[h].replace(Ob, "$1" + e) : b.jsonp !== !1 && (b.url += (pb.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), b.converters["script json"] = function () {
    ...
    var d,
        ...
        f,
        g = this,
        h = a.indexOf(" ");return h > -1 && (d = o.trim(a.slice(h)), a = a.slice(0, h)), o.isFunction(b) ? (c = b, b = void 0) : b && "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) && (e = "POST"), g.length > 0 && o.ajax({ url: a, type: e || "GET", dataType: "html", data: b }).done(function (a) {
    ...
    return o.isWindow(a) ? a : 9 === a.nodeType && a.defaultView;
      ...
      if (arguments.length) return void 0 === a ? this : this.each(function (b) {
        o.offset.setOffset(this, a, b);
          ...
          d,
          e,
          f = this[0];if (f) return f.getClientRects().length ? (d = f.getBoundingClientRect(), d.width || d.height ? (e = f.ownerDocument, c = Pb(e), b = e.documentElement, { top: d.top + c.pageYOffset - b.clientTop, left: d.left + c.pageXOffset - b.clientLeft }) : d) : { top: 0, left: 0 };
    ...
    var c = "pageYOffset" === b;o.fn[a] = function (d) {
      return O(this, function (a, d, e) {
        var f = Pb(a);return void 0 === e ? f ? f[b] : a[d] : void (f ? f.scrollTo(c ? f.pageXOffset : e, c ? e : f.pageYOffset) : a[d] = e);
  ...
  }), o.fn.extend({ bind: function bind(a, b, c) {
    ...
    return o;
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));var Qb = a.jQuery,
      Rb = a.$;return o.noConflict = function (b) {
